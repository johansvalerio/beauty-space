      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 ">
          ...
          <div className="relative">
            <Card className="bg-white dark:bg-background/20 shadow-xl dark:shadow-gray-900/0 border border-gray-100 dark:border-gray-700">
              <CardHeader>
                <CardTitle className="dark:text-white">Reservaciones</CardTitle>
