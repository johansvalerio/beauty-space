...
function RegisterForm() {
    ...
    async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        const imageInput = event.currentTarget.querySelector<HTMLInputElement>('input[type="file"]');
        let imageUrl = '';
    ...
    return (
        <div className="md:px-6 lg:px-8">
            <h2 className="text-3xl font-bold tracking-tight text-white md:text-4xl lg:text-4xl bg-gradient-to-r from-rose-400 to-purple-400 p-4 rounded-lg rounded-br-none rounded-bl-none">Regístrate</h2>
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    className="focus:ring-none mt-1 block w-full rounded-md bg-background px-3 py-2 text-foreground shadow-sm border-gray-400"
                                />
                                <span className="text-muted-foreground text-sm">Utilizar el formato que se muestra</span>
                            </div>
                            <div>
                            ...
                            {selectImage && (
                                <div className="col-span-2">
                                    <img src={selectImage} alt="Imagen seleccionada" className="w-24 h-24 rounded-md object-cover" />
                                </div>
                            )}
